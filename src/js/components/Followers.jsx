            ...
            return (  
                ...
                <div className="followers-page">
                    <h2>Followers of {this.props.params.username}</h2>
                        <ul>
                            {this.state.followers.map(function(eachFollower) {return(
                                <GithubUser id = {eachFollower.id} user = {eachFollower} />
                            );
                        })}              
                        </ul>
                    </div>
